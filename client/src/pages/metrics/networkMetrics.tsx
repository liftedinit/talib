import { Box, SimpleGrid } from "@liftedinit/ui";
    ...
    <>
      ...
      <SimpleGrid columns={3} gap="6" mt={2}>
        <Box>
          ...
          <MetricChart label="Total Memory" type="area" metric="totalmemory" conversion={convertBytesToTb} from={"now-14d"} to={"now"} fixedDecimals="2" intervalMs="15000" maxDataPoints="250" ytitle="TB" />
        </Box>
        <Box>
          ...
          <MetricChart label="Free Memory" type="area" metric="freememory" conversion={convertBytesToTb} from={"now-14d"} to={"now"} fixedDecimals="2" intervalMs="15000" maxDataPoints="250" ytitle="TB" />
        </Box>
        <Box>
          ...
          <MetricChart label="Used Memory" type="area" metric="usedmemory" conversion={convertBytesToTb} from={"now-14d"} to={"now"} fixedDecimals="2" intervalMs="15000" maxDataPoints="250" ytitle="TB" />
        </Box>
      </SimpleGrid>
    </>
  );
